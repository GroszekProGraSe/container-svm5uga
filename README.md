...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-svm5uga.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-svm5uga.containers.anotherwebservice.com/
...
```
git clone git@github.com:GroszekProGraSe/container-svm5uga.git
cd container-svm5uga
```
...
```
docker attach container-svm5uga
```
